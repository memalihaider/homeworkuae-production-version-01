...
export default function GroutDeepCleaning() {
  const categories = [
    {
      ...
      icon: Search,
      items: [
        { name: "Grout Assessment", desc: "Thorough inspection of your grout lines to identify stains, discoloration, and areas requiring special attention." },
        { name: "Customized Cleaning Plan", desc: "Developing a tailored cleaning plan based on the type and condition of your grout." }
      ]
    },
    {
      title: "Deep Cleaning",
      icon: Droplets,
      items: [
        { name: "Eco-Friendly Solutions", desc: "Utilizing safe and effective cleaning solutions to break down dirt and stains without damaging the grout." },
        { name: "High-Pressure Steam Cleaning", desc: "Employing high-pressure steam cleaning to penetrate and lift dirt from deep within the grout lines." },
        { name: "Manual Scrubbing", desc: "Hand scrubbing stubborn stains to ensure every inch of your grout is thoroughly cleaned." }
      ]
    },
    {
      ...
      icon: Shield,
      items: [
        { name: "Grout Sealing", desc: "Applying a high-quality sealant to protect grout lines from future stains and moisture, extending their lifespan." },
        { name: "Color Restoration", desc: "Offering grout color sealing options to enhance or change the color of your grout, giving your tiles a fresh new look." }
      ]
    },
    {
      ...
      icon: Star,
      items: [
        { name: "Final Assessment", desc: "Conducting a final inspection to ensure all grout lines are clean, uniform, and free of residue." },
        { name: "Customer Approval", desc: "Ensuring your complete satisfaction with the results before we consider the job done." }
      ]
    }
  ]
  ...
  const servicesList = [
    ...
    { name: "Office Deep Cleaning", slug: "office-deep-cleaning" },
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          >
            ...
            <h1 className="text-6xl md:text-8xl font-black tracking-tighter mb-8 leading-[0.9]">
              REVITALIZE <br />
              <span className="text-primary italic">YOUR TILES</span>
            </h1>
            <p className="text-xl text-slate-300 max-w-2xl mx-auto leading-relaxed font-medium uppercase tracking-tight">
              Expert Grout Cleaning Services in UAE – Fresh and Disinfected
            </p>
          </motion.div>
        </div>
      </section>
              ...
              >
                <div className="space-y-6">
                  ...
                  <p className="text-slate-600 text-lg font-medium leading-relaxed">
                    Are you tired of dirty, stained grout lines diminishing the beauty of your tiles? Homework Cleaning Services LLC offers professional grout deep cleaning services to restore the original look of your tiled surfaces. Our expert team uses advanced cleaning techniques and eco-friendly products to effectively remove dirt, grime, and stains from your grout lines.
                  </p>
                  <div className="p-8 bg-slate-50 rounded-3xl border-l-4 border-primary">
                    <p className="text-slate-700 font-bold italic">
                      "Grout Deep Cleaning is essential to keep your home clean and organized efficiently. Here's our specialized approach to grout restoration."
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-12">
                  <h3 className="text-3xl font-black text-slate-900 tracking-tight flex items-center gap-4 uppercase">
                    ...
                    Our Comprehensive Grout Cleaning Services:
                  </h3>
                  ...
                  {servicesList.map((service, i) => (
                    <a 
                      ...
                      className={`flex items-center justify-between p-4 rounded-2xl border transition-all ${
                        service.slug === "grout-deep-cleaning" 
      ...
      <section className="py-24 bg-slate-50 relative overflow-hidden">
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-20">
            ...
            <p className="text-slate-600 font-bold max-w-2xl mx-auto">Restoring the sparkle to your tiled surfaces across the UAE.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
            {[
              { 
                title: "Expertise", 
                desc: "Our team is highly trained and experienced in grout deep cleaning, ensuring top-quality results.", 
                icon: ShieldCheck 
              },
              { 
                title: "Attention to Detail", 
                desc: "We focus on every inch of your grout lines, ensuring they are spotless and revitalized.", 
                icon: Sparkles 
              },
              { 
          ...
          >
            <div className="relative z-10">
              <h4 className="text-4xl md:text-5xl font-black text-white mb-8 tracking-tighter">Restore Your <span className="text-primary italic">Tiles' Beauty</span></h4>
              <p className="text-slate-400 text-lg mb-10 font-bold">Contact us today for a professional grout deep cleaning experience.</p>
            ...
            <Grid3X3 className="absolute -bottom-10 -right-10 h-64 w-64 text-white/5 rotate-12 group-hover:scale-110 transition-transform duration-1000" />
          </motion.div>
        </div>
      </section>
    </div>
