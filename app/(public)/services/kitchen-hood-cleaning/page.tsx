...
export default function KitchenHoodCleaning() {
  return <ServicePageTemplate slug="kitchen-hood-cleaning" />
}
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          >
            ...
            <h1 className="text-6xl md:text-8xl font-black tracking-tighter mb-8 leading-[0.9]">
              KITCHEN HOOD <br />
              <span className="text-primary italic">HYGIENE EXPERTS</span>
            </h1>
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            >
              <div className="inline-flex items-center gap-3 text-primary">
                ...
                <span className="text-sm font-black uppercase tracking-widest">Hood Cleaning Specialists</span>
              </div>
              <h2 className="text-4xl md:text-5xl font-black text-slate-900 tracking-tighter leading-tight">
                Safety & Compliance: <br />
                <span className="text-primary italic">Kitchen Exhaust Maintenance</span>
              </h2>
              <p className="text-slate-600 text-lg font-medium leading-relaxed">
                When you think of a restaurant's kitchen, the focus usually goes to the food being prepared. Yet, one crucial component often overlooked is the kitchen hood. Regular cleaning of this system is not just good practice — it's essential for safety and compliance. Cooking equipment is the leading cause of restaurant fires, accounting for over 50% of all incidents.
              </p>
              ...
              <div className="grid gap-4">
                {[
                  ...
                  "Full System Dismantling & Prep",
                  "Heavy-Duty Chemical Degreasing",
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
              >
                Book Hood Cleaning <ArrowRight className="h-5 w-5" />
              </motion.a>
            </motion.div>
          </div>
        </div>
