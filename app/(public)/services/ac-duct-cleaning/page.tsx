  ...
  return (
    <>
      ...
      <main className="bg-slate-50 text-slate-900 selection:bg-blue-100 selection:text-blue-900">
        <section className="relative flex min-h-[78vh] items-center overflow-hidden bg-[#0a192f] text-white md:min-h-[85vh]">
          ...
          <div className="container relative z-10 mx-auto px-4 py-14 sm:px-6 sm:py-16 md:py-20 lg:py-24">
            <div className="max-w-3xl">
              ...
              <div className="flex max-w-md flex-col gap-3 sm:max-w-none sm:flex-row sm:flex-wrap sm:gap-5">
                <Link href="/book-service" className="group relative flex items-center justify-center gap-3 overflow-hidden rounded-full bg-blue-600 px-6 py-3.5 text-xs font-black uppercase tracking-[0.14em] text-white transition-all duration-300 hover:bg-blue-500 hover:shadow-[0_0_30px_rgba(37,99,235,0.4)] sm:px-8 sm:py-4 sm:text-sm sm:tracking-widest">
                ...
                <a href="tel:+971507177059" className="flex items-center justify-center gap-3 rounded-full border border-white/20 bg-white/5 px-6 py-3.5 text-xs font-black uppercase tracking-[0.14em] text-white backdrop-blur-md transition-all duration-300 hover:border-white/40 hover:bg-white/10 sm:px-8 sm:py-4 sm:text-sm sm:tracking-widest">
        ...
        <section className="bg-[#f3f5f8] py-14 sm:py-16 md:py-20 xl:py-24">
          <div className="container mx-auto grid items-center gap-10 px-4 sm:gap-12 sm:px-6 lg:grid-cols-[1.1fr_0.9fr]">
            <div>
              <span className="inline-flex items-center gap-3 bg-[#0f3a73] px-4 py-2 text-[10px] font-black uppercase tracking-[0.12em] text-blue-100 sm:text-[11px] sm:tracking-[0.18em]">
                Dubai AC Duct Cleaning Services
                <span className="h-0.5 w-10 bg-cyan-400" />
              </span>
              <h2 className="mt-5 max-w-2xl text-3xl font-black leading-[1.1] tracking-tight text-[#173b6c] sm:text-4xl md:text-5xl xl:text-6xl">
                Dubai AC Duct Cleaning Services
              </h2>
            ...
            <div className="relative mx-auto w-full max-w-md sm:max-w-140">
              ...
              <div className="absolute -bottom-8 right-4 hidden h-28 w-28 items-center justify-center rounded-full bg-linear-to-b from-cyan-500 to-[#0f3a73] p-4 text-center text-xs font-black leading-tight text-white shadow-2xl sm:flex md:right-6 md:h-36 md:w-36 md:p-5 md:text-sm">
        ...
        <section className="py-14 sm:py-16 md:py-20 xl:py-24">
          <div className="container mx-auto px-4 sm:px-6">
            <div className="mb-12 flex flex-col items-center text-center sm:mb-16">
              <span className="mb-4 inline-block text-[10px] font-black uppercase tracking-[0.22em] text-blue-600 sm:text-[11px] sm:tracking-[0.3em]">Dubai's Best AC Duct Cleaning</span>
              <h2 className="max-w-2xl text-3xl font-black tracking-tight text-slate-900 sm:text-4xl md:text-4xl lg:text-5xl">What We <span className="text-blue-600">Offer You</span></h2>
            ...
            <div className="mx-auto grid max-w-6xl gap-5 sm:grid-cols-2 sm:gap-6 lg:grid-cols-4 lg:gap-7">
              {offerCards.map((card) => {
                ...
                return (
                  <article key={card.title} className="group relative overflow-hidden rounded-3xl border border-slate-100 bg-white p-6 shadow-xs transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl hover:shadow-blue-500/10 sm:rounded-[2.5rem] sm:p-7 lg:p-8">
                    ...
                    <div className="relative z-10 mb-6 flex h-14 w-14 items-center justify-center rounded-2xl bg-blue-600 text-white shadow-xl shadow-blue-600/20 transition-transform duration-500 group-hover:rotate-6 sm:h-16 sm:w-16">
        ...
        <section className="bg-slate-900 py-14 text-white sm:py-16 md:py-20 xl:py-24">
          <div className="container mx-auto px-4 sm:px-6">
            <div className="mb-12 flex flex-col items-center text-center sm:mb-16">
              <span className="mb-4 inline-block text-[10px] font-black uppercase tracking-[0.22em] text-blue-400 sm:text-[11px] sm:tracking-[0.3em]">Quality You Can See</span>
              <h2 className="text-3xl font-black tracking-tight sm:text-4xl md:text-4xl lg:text-5xl">Quality <span className="italic text-blue-400">You Can See</span></h2>
            ...
            <div className="mx-auto max-w-6xl">
              <article className="group overflow-hidden rounded-3xl border border-blue-500/20 bg-blue-500/5 shadow-2xl transition-all duration-500 hover:border-blue-500/40 hover:bg-blue-500/[0.07] sm:rounded-[3rem]">
                ...
                <div className="p-6 sm:p-8">
                  <p className="text-sm font-medium leading-relaxed text-blue-100/60">Real project results captured after professional AC duct cleaning.</p>
                </div>
              </article>
            </div>
          </div>
        ...
        <section className="bg-slate-50 py-14 sm:py-16 md:py-20 xl:py-24">
          <div className="container mx-auto px-4 sm:px-6">
            ...
            <div className="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-2xl sm:rounded-[3rem]">
              <div className="grid lg:grid-cols-2">
                ...
                <div className="p-6 sm:p-7 lg:p-10 xl:p-12">
                  ...
                  <div className="mt-10 rounded-[2rem] bg-blue-600 p-6 text-white shadow-2xl shadow-blue-600/30 sm:mt-12 sm:p-7 lg:p-8">
                    ...
                    <Link href="/book-service" className="mt-6 inline-flex items-center justify-center gap-3 rounded-full bg-white px-6 py-3 text-xs font-black uppercase tracking-widest text-blue-600 transition-all duration-300 hover:scale-105">
                      Check Availability
                    </Link>
                  </div>
                </div>
        ...
        <section className="relative overflow-hidden bg-linear-to-r from-[#123c67] to-[#2b4f87] py-14 text-white sm:py-16 md:py-20 xl:py-24">
          ...
          <div className="container relative z-10 mx-auto grid items-center gap-10 px-4 sm:gap-10 sm:px-6 lg:gap-12 lg:grid-cols-[0.95fr_1.05fr]">
            <div className="relative mx-auto w-full max-w-sm sm:max-w-xl">
              ...
              <div className="absolute -bottom-10 left-1/2 hidden h-40 w-40 -translate-x-1/2 items-center justify-center rounded-full bg-linear-to-b from-cyan-500 to-blue-900 p-6 text-center text-sm font-black leading-tight text-white shadow-2xl md:flex">
                Professional Service
                <br />
            ...
            <div>
              ...
              <ul className="mt-7 space-y-3 text-base leading-relaxed text-blue-50/95 sm:text-lg">
              ...
              <p className="mt-7 max-w-3xl text-lg font-semibold leading-relaxed text-blue-100/95 sm:text-xl lg:text-2xl xl:text-3xl">
              ...
              <div className="mt-8 flex max-w-md flex-col gap-3 sm:max-w-none sm:flex-row sm:flex-wrap sm:gap-4">
                <a href="tel:+971507177059" className="inline-flex items-center justify-center gap-2 bg-white px-6 py-3 text-xs font-black uppercase tracking-[0.12em] text-[#1a3c6b] transition hover:bg-slate-100 sm:text-sm">
                  Call +971 50 717 7059
                  <ArrowRight className="h-4 w-4" />
                </a>
                <Link href="/book-service" className="inline-flex items-center justify-center gap-2 bg-white px-6 py-3 text-xs font-black uppercase tracking-[0.12em] text-[#1a3c6b] transition hover:bg-slate-100 sm:text-sm">
                  Book Online
                  <ArrowRight className="h-4 w-4" />
                </Link>
              </div>
        ...
        <section className="bg-white py-14 sm:py-16 md:py-20 xl:py-24">
          <div className="container mx-auto px-4 sm:px-6">
            <div className="flex flex-col items-center text-center">
              <span className="mb-4 inline-block text-[10px] font-black uppercase tracking-[0.22em] text-blue-600 sm:text-[11px] sm:tracking-[0.3em]">The Blueprint</span>
              <h2 className="text-3xl font-black tracking-tight text-slate-900 sm:text-4xl md:text-4xl lg:text-5xl">Our Workflow <span className="text-blue-600">Protocol</span></h2>
              <div className="mt-6 h-1 w-20 rounded-full bg-blue-600" />
            </div>
            ...
            <div className="mt-12 grid gap-5 sm:mt-14 sm:gap-6 md:grid-cols-2 lg:mt-16 lg:grid-cols-4">
              {processSteps.map((step, idx) => {
                ...
                return (
                  <article key={step.title} className="group relative rounded-3xl border border-slate-100 bg-slate-50 p-6 transition-all duration-500 hover:bg-white hover:shadow-2xl hover:shadow-blue-600/5 sm:rounded-[2rem] sm:p-7 lg:p-8">
                    <div className="mb-8 flex items-center justify-between">
                      <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-white text-blue-600 shadow-xl shadow-blue-600/10 ring-1 ring-blue-50 transition-colors duration-500 group-hover:bg-blue-600 group-hover:text-white sm:h-14 sm:w-14">
            ...
            <div className="mt-16 text-center">
              <Link href="/book-service" className="inline-flex items-center gap-4 rounded-full bg-blue-600 px-7 py-4 text-xs font-black uppercase tracking-widest text-white transition-all duration-300 hover:scale-105 hover:bg-blue-500 hover:shadow-[0_20px_40px_rgba(37,99,235,0.3)] sm:px-10 sm:py-5 sm:text-sm">
          ...
          <div className="container mx-auto px-4 sm:px-6">
            <div className="mx-auto flex max-w-6xl flex-col items-center gap-8 sm:gap-12 lg:gap-14 lg:flex-row">
              <div className="lg:w-1/2">
                <span className="mb-4 inline-block text-[10px] font-black uppercase tracking-[0.22em] text-blue-600 sm:text-[11px] sm:tracking-[0.3em]">The Experts</span>
                <h2 className="text-3xl font-black tracking-tight text-slate-900 sm:text-4xl md:text-4xl lg:text-5xl">Elite Air <br className="hidden sm:block" /><span className="text-blue-600">Technicians</span></h2>
                ...
                <div className="mt-10 space-y-4">
                  {[
                    ...
                    <div key={i} className="flex items-center gap-4 rounded-3xl border border-slate-200/50 bg-white p-4 shadow-sm transition-all duration-300 hover:border-blue-200 hover:shadow-xl hover:shadow-blue-500/5 sm:gap-5 sm:p-4 lg:gap-6 lg:p-5">
                ...
                <div className="mt-12">
                  <Link href="/book-service" className="inline-flex items-center gap-3 rounded-full bg-slate-900 px-8 py-4 text-[11px] font-black uppercase tracking-widest text-white transition-all duration-300 hover:bg-blue-600 sm:text-xs">
                    Consult Our Team
                  </Link>
                </div>
              </div>
        ...
        <section className="bg-slate-900 py-14 text-white sm:py-16 md:py-20 xl:py-24">
          <div className="container mx-auto px-4 sm:px-6">
            <div className="mb-12 flex flex-col items-center text-center sm:mb-20">
              <span className="mb-4 inline-block text-[10px] font-black uppercase tracking-[0.22em] text-blue-400 sm:text-[11px] sm:tracking-[0.3em]">Clear Answers</span>
            ...
            <div className="mx-auto max-w-4xl space-y-6">
              {faqs.map((item) => (
                <details key={item.q} className="group overflow-hidden rounded-2xl border border-white/5 bg-white/5 transition-all duration-500 open:border-white/10 open:bg-white/8 sm:rounded-[2rem]">
                  <summary className="flex cursor-pointer list-none items-center justify-between gap-4 p-5 text-base font-black tracking-tight sm:p-6 sm:text-lg md:text-xl lg:p-8">
                    {item.q}
                    <div className="flex h-9 w-9 items-center justify-center rounded-full bg-white/5 transition-transform duration-500 group-open:rotate-180 sm:h-10 sm:w-10">
                      <ArrowRight className="h-5 w-5 rotate-90" />
                    </div>
                  </summary>
                  <div className="px-5 pb-5 text-slate-400 sm:px-6 sm:pb-6 lg:px-8 lg:pb-8">
        ...
        <section className="bg-white py-14 sm:py-16 md:py-20 xl:py-24">
          <div className="container mx-auto px-4 text-center sm:px-6">
            <span className="mb-4 inline-block text-[10px] font-black uppercase tracking-[0.22em] text-blue-600 sm:text-[11px] sm:tracking-[0.3em]">Google Reviews</span>
            <h2 className="text-3xl font-black tracking-tight text-slate-900 sm:text-4xl md:text-4xl lg:text-5xl">What Our <span className="text-blue-600">Customers</span> Say</h2>
            
            <div className="mt-10 grid gap-5 sm:mt-14 sm:gap-6 md:grid-cols-2 xl:grid-cols-3">
              {reviews.map((review) => (
                <article key={review.name} className="flex w-full flex-col rounded-3xl border border-slate-100 bg-slate-50 p-6 text-left shadow-xs transition-all duration-500 hover:-translate-y-2 hover:bg-white hover:shadow-2xl hover:shadow-blue-600/5 sm:rounded-[3rem] sm:p-7 md:p-8 lg:p-9">
