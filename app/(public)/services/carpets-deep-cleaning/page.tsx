      ...
      <section className="py-24 bg-slate-50 relative overflow-hidden">
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-20">
            ...
            <p className="text-slate-600 font-bold max-w-2xl mx-auto">Restoring the beauty and hygiene of your carpets across the UAE.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
            {[
              { 
                title: "Expertise", 
                desc: "Our team is highly trained and experienced in carpet deep cleaning, ensuring top-quality results.", 
                icon: ShieldCheck 
              },
              { 
                title: "Attention to Detail", 
                desc: "We focus on every inch of your carpets, ensuring they are spotless and well-maintained.", 
                icon: Sparkles 
              },
              { 
