          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            >
              <div className="inline-flex items-center gap-3 text-primary">
                ...
                <span className="text-sm font-black uppercase tracking-widest">Balcony Specialists</span>
              </div>
              <h2 className="text-4xl md:text-5xl font-black text-slate-900 tracking-tighter leading-tight">
                Restore Your <br />
                <span className="text-primary italic">Outdoor Living Space</span>
              </h2>
              ...
              <div className="grid gap-4">
                {[
                  "Thorough Sweeping & Vacuuming",
                  "Deep Mopping & Scrubbing",
                  "Railing & Handrail Polishing",
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
              >
                Book Balcony Deep Clean <ArrowRight className="h-5 w-5" />
              </motion.a>
            </motion.div>
          </div>
        </div>
