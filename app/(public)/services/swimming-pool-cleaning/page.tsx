        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          >
            ...
            <h1 className="text-6xl md:text-8xl font-black tracking-tighter mb-8 leading-[0.9]">
              CRYSTAL CLEAR <br />
              <span className="text-primary italic">DIVE-IN WATERS</span>
            </h1>
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            >
              <div className="inline-flex items-center gap-3 text-primary">
                ...
                <span className="text-sm font-black uppercase tracking-widest">Pool Care Specialists</span>
              </div>
              <h2 className="text-4xl md:text-5xl font-black text-slate-900 tracking-tighter leading-tight">
                Maintain Your Oasis: <br />
                <span className="text-primary italic">Aquatic Health Mastery</span>
              </h2>
              <p className="text-slate-600 text-lg font-medium leading-relaxed">
                Keeping your swimming pool clean and well-maintained is essential for enjoying a safe and refreshing swim. At Homework Cleaning Services LLC, we offer comprehensive swimming pool cleaning services to ensure your pool is crystal clear and inviting using advanced equipment and eco-friendly products.
              </p>

              <div className="grid gap-4">
                {[
                  "Surface Skimming & Debris Removal",
                  "Precision Vacuum Cleaning",
                  "Advanced Water Chemistry Testing",
                  "Chemical Balancing & Treatment",
                  "Targeted Algae Killing & Brushing",
                  "Pump & Filter Circulation Check",
                ].map((item, i) => (
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
              >
                Book Pool Cleaning <ArrowRight className="h-5 w-5" />
              </motion.a>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-24 bg-slate-950 text-white relative">
        ...
        >
          <div className="relative z-10">
            <h4 className="text-4xl md:text-5xl font-black text-white mb-8 tracking-tighter">Dive Into a <span className="text-primary italic">Crystal Clear Pool</span></h4>
            <p className="text-slate-400 text-lg mb-10 font-bold">Contact us today for professional swimming pool cleaning services.</p>
