      ...
      <section className="py-24 bg-slate-900 overflow-hidden relative">
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center mb-16">
            <h2 className="text-sm font-black text-primary uppercase tracking-[0.4em] mb-4">Fire Safety In Action</h2>
            <h3 className="text-4xl md:text-5xl font-black text-white tracking-tighter uppercase mb-6">WATCH OUR DEGREASING PROCESS</h3>
          </div>
      ...
      <section className="py-24 bg-slate-50 relative overflow-hidden">
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-20">
            ...
            <h3 className="text-5xl font-black text-slate-900 tracking-tighter uppercase mb-6">WHY REGULAR CLEANING MATTERS?</h3>
            <p className="text-slate-600 font-bold max-w-2xl mx-auto italic">“NFPA states that cooking equipment is the leading cause of restaurant fires, accounting for over 50% of incidents.”</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
            {[
              { 
                ...
                desc: "We eliminate the grease buildup that acts as fuel for flash fires, protecting your kitchen and your investment.", 
                icon: Flame 
              },
              { 
                title: "Insurance & Compliance", 
                desc: "Avoid the 30% increase in premiums associated with poor maintenance and ensure total compliance with local fire codes.", 
                icon: ShieldCheck 
              },
              { 
                title: "Air Quality & Hygiene", 
                desc: "A clean hood ensures effective smoke removal, positively affecting the health and comfort of your employees and customers.", 
                icon: Wind 
              },
              { 
                title: "Operational Efficiency", 
                desc: "Well-maintained exhaust systems improve heat removal, speeding up cooking times and extending equipment lifespan.", 
                icon: Zap 
              }
            ].map((value, i) => (
              <motion.div
          ...
          >
            <div className="relative z-10">
              <h4 className="text-4xl md:text-5xl font-black text-white mb-8 tracking-tighter uppercase whitespace-pre-line">
                PRIORITIZE KITCHEN SAFETY FOR{"\n"}
                <span className="text-primary italic text-3xl md:text-5xl uppercase">SUCCESS AND SURVIVAL</span>
              </h4>
            ...
            <Fan className="absolute -bottom-10 -left-10 h-64 w-64 text-white/5 rotate-12 group-hover:scale-110 transition-transform duration-1000" />
