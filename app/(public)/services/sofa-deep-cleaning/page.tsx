  ...
  const categories = [
    {
      ...
      icon: Search,
      items: [
        { name: "Fabric Assessment", desc: "Thorough inspection of your sofa’s fabric to determine the most suitable cleaning method." },
    ...
    },
    {
      ...
      icon: Droplets,
      items: [
        { name: "Vacuuming", desc: "Using powerful vacuums to remove dust, dirt, and pet hair from the surface and crevices of your sofa." },
        { name: "Steam Cleaning", desc: "Employing steam cleaning to penetrate deep into the fabric, lifting dirt and grime while sanitizing the upholstery." }
      ]
    },
    {
      ...
      icon: Sparkles,
      items: [
        { name: "Stain Treatment", desc: "Treating and removing tough stains, such as food spills, ink, and pet stains, to restore your sofa’s appearance." },
        { name: "Odor Elimination", desc: "Applying deodorizing agents to eliminate unpleasant odors, leaving your sofa smelling fresh and clean." }
      ]
    },
    {
      title: "Post-Cleaning Protection",
      icon: Shield,
      items: [
        { name: "Fabric Protection", desc: "Applying a fabric protectant to guard against future stains and spills, extending the life of your upholstery." },
        { name: "Final Inspection", desc: "Conducting a final inspection to ensure your sofa is thoroughly cleaned and meets our high standards of quality." }
      ]
    }
  ]
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          >
            ...
            <h1 className="text-6xl md:text-8xl font-black tracking-tighter mb-8 leading-[0.9]">
              REVITALIZE <br />
              <span className="text-primary italic">YOUR SOFA</span>
            </h1>
            <p className="text-xl text-slate-300 max-w-2xl mx-auto leading-relaxed font-medium uppercase tracking-tight">
              Revitalize Your Sofa with UAE's Expert Deep Cleaning Services
            </p>
          </motion.div>
        </div>
      </section>
              ...
              >
                <div className="space-y-6">
                  ...
                  <div className="p-8 bg-slate-50 rounded-3xl border-l-4 border-primary">
                    <p className="text-slate-700 font-bold italic">
                      "Deep cleaning your sofa helps remove dirt, stains, and odors, extending its life and improving its appearance. Here's a step-by-step guide for deep cleaning various types of sofas."
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-12">
                  <h3 className="text-3xl font-black text-slate-900 tracking-tight flex items-center gap-4 uppercase">
                    ...
                    Our Comprehensive Sofa Deep Cleaning Services:
                  </h3>
                  ...
                  {servicesList.map((service, i) => (
                    <a 
                      ...
                      className={`flex items-center justify-between p-4 rounded-2xl border transition-all ${
                        service.slug === "sofa-deep-cleaning" 
      ...
      <section className="py-24 bg-slate-50 relative overflow-hidden">
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-20">
            ...
            <p className="text-slate-600 font-bold max-w-2xl mx-auto">Providing luxury care for your furniture across the UAE.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { 
                title: "Expertise", 
                desc: "Our team is highly trained and experienced in sofa deep cleaning, ensuring top-quality results.", 
                icon: ShieldCheck 
              },
              { 
                title: "Eco-Friendly", 
              ...
              { 
                ...
                desc: "We focus on every inch of your sofa, ensuring it is spotless and well-maintained.", 
                icon: Sparkles 
              },
              { 
          ...
          >
            ...
            <Sofa className="absolute -bottom-10 -right-10 h-64 w-64 text-white/5 rotate-12 group-hover:scale-110 transition-transform duration-1000" />
          </motion.div>
        </div>
      </section>
