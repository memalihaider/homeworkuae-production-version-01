...
export default function GroutDeepCleaning() {
  return <ServicePageTemplate slug="grout-deep-cleaning" />
}

import { motion } from 'framer-motion'
import { CheckCircle2, ArrowRight, Grid2x2 } from 'lucide-react'
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            >
              <div className="inline-flex items-center gap-3 text-primary">
                ...
                <span className="text-sm font-black uppercase tracking-widest">Grout Specialists</span>
              </div>
              <h2 className="text-4xl md:text-5xl font-black text-slate-900 tracking-tighter leading-tight">
                Restore Your Tiles & <br />
                <span className="text-primary italic">Grout Lines</span>
              </h2>
              <p className="text-slate-600 text-lg font-medium leading-relaxed">
                Are you tired of dirty, stained grout lines diminishing the beauty of your tiles? Homework Cleaning Services LLC offers professional grout deep cleaning services to restore the original look of your tiled surfaces using advanced techniques and eco-friendly products.
              </p>

              <div className="grid gap-4">
                {[
                  "Thorough Grout Assessment",
                  "Eco-Friendly Solution Application",
                  "High-Pressure Steam Cleaning",
                  "Manual Hard Stain Scrubbing",
                  "Premium Grout Sealing",
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
              >
                Book Grout Deep Clean <ArrowRight className="h-5 w-5" />
              </motion.a>
            </motion.div>
          </div>
        </div>
