...
export default function WaterTankCleaning() {
  return <ServicePageTemplate slug="water-tank-cleaning" />
}
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          >
            ...
            <h1 className="text-6xl md:text-8xl font-black tracking-tighter mb-8 leading-[0.9]">
              PURE WATER <br />
              <span className="text-primary italic">STORAGE SOLUTIONS</span>
            </h1>
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            >
              <div className="inline-flex items-center gap-3 text-primary">
                ...
                <span className="text-sm font-black uppercase tracking-widest">Water Hygiene Specialists</span>
              </div>
              <h2 className="text-4xl md:text-5xl font-black text-slate-900 tracking-tighter leading-tight">
                Protect Your Health: <br />
                <span className="text-primary italic">Tank Sanitization Experts</span>
              </h2>
              <p className="text-slate-600 text-lg font-medium leading-relaxed">
                Water tanks are an essential part of many homes and businesses, providing a vital resource for daily needs. Dirty water tanks can harbor harmful bacteria, viruses, and parasites. At Homework Cleaning Services LLC, we provide municipality-standard disinfection to ensure your family or staff have access to crisp, safe drinking water.
              </p>

              <div className="grid gap-4">
                {[
                  "Water Pathogen Risk Assessment",
                  "Discolouration & Contamination Check",
                  "Full Tank Evacuation & Draining",
                  "Food-Grade Chemical Sanitizing",
                  "Quarterly Inspection Programme",
                  "Filtration Upgrade Consultation",
                ].map((item, i) => (
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
              >
                Book Tank Cleaning <ArrowRight className="h-5 w-5" />
              </motion.a>
            </motion.div>
          </div>
        </div>
