  ...
  const categories = [
    {
      ...
      icon: Layout,
      items: [
        { name: "Sweeping and Vacuuming", desc: "Removing loose dirt, dust, leaves, and debris from the balcony floor." },
        { name: "Mopping and Scrubbing", desc: "Deep cleaning of balcony floors to remove stains, dirt, and grime, ensuring a spotless finish." },
        { name: "Railing and Handrail Cleaning", desc: "Wiping down railings and handrails to remove dust and fingerprints." }
      ]
    },
    {
      ...
      icon: Sparkles,
      items: [
        { name: "Outdoor Furniture", desc: "Cleaning and sanitizing outdoor furniture, including chairs, tables, and loungers to remove dirt and mildew." },
        { name: "Cushions and Fabrics", desc: "Spot cleaning and sanitizing outdoor cushions, pillows, and fabrics to maintain a fresh and inviting appearance." }
      ]
    },
    {
      ...
      icon: Glasses,
      items: [
        { name: "Window Cleaning", desc: "Thorough cleaning of windows, frames, and sills to ensure a clear and streak-free finish." },
        { name: "Glass Railings", desc: "Cleaning glass railings to enhance visibility and appearance." }
      ]
    },
    {
      ...
      icon: Droplets,
      items: [
        { name: "Pressure Washing", desc: "Using high-pressure washing for deep cleaning of stubborn stains and grime on the balcony surface." },
        { name: "Odor Removal", desc: "Applying deodorizing agents to eliminate any unpleasant odors, leaving your balcony smelling fresh and clean." }
      ]
    }
  ]
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          >
            ...
            <h1 className="text-6xl md:text-8xl font-black tracking-tighter mb-8 leading-[0.9]">
              PRISTINE <br />
              <span className="text-primary italic">BALCONY</span> CLEANING
            </h1>
            <p className="text-xl text-slate-300 max-w-2xl mx-auto leading-relaxed font-medium uppercase tracking-tight">
              Pristine Balcony Deep Cleaning in UAE – Enjoy Your Outdoor Space
            </p>
          </motion.div>
        </div>
      </section>
              ...
              >
                <div className="space-y-6">
                  ...
                  <div className="p-8 bg-slate-50 rounded-3xl border-l-4 border-primary">
                    <p className="text-slate-700 font-bold italic">
                      "Deep cleaning your balcony ensures a fresh, inviting outdoor space free of grime and clutter. Here's a step-by-step guide for achieving a pristine finish."
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-12">
                  <h3 className="text-3xl font-black text-slate-900 tracking-tight flex items-center gap-4 uppercase">
                    ...
                    Our Balcony Cleaning Services Include:
                  </h3>
                  ...
                  {servicesList.map((service, i) => (
                    <a 
                      ...
                      className={`flex items-center justify-between p-4 rounded-2xl border transition-all ${
                        service.slug === "balcony-deep-cleaning" 
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { 
                title: "Expertise", 
                desc: "Our team is highly trained and experienced in balcony cleaning, ensuring top-quality results.", 
                icon: ShieldCheck 
              },
              { 
                title: "Eco-Friendly", 
                desc: "We use environmentally friendly products to ensure a safe and healthy outdoor environment.", 
                icon: Droplets 
              },
              { 
                title: "Attention to Detail", 
                desc: "We focus on every nook and cranny, ensuring your balcony is spotless and well-maintained.", 
                icon: Sparkles 
              },
              { 
          ...
          >
            ...
            <Wind className="absolute -bottom-10 -right-10 h-64 w-64 text-white/5 rotate-12 group-hover:scale-110 transition-transform duration-1000" />
          </motion.div>
        </div>
      </section>
