  ...
  const categories = [
    {
      ...
      icon: Layers,
      items: [
        { name: "Interior & Exterior cleaning", desc: "Meticulous cleaning and sanitization of the inside and outside of all cabinets and drawers to remove dust, grease, and residue." },
        { name: "Organizing", desc: "Professional assistance in organizing your kitchen items for a more efficient and tidy workspace." }
      ]
    },
    {
      ...
      icon: Sparkles,
      items: [
        { name: "Stain Removal", desc: "Thorough scrubbing and sanitizing of countertops and backsplashes to remove stubborn stains, grease, and spills." },
        { name: "Sanitizing", desc: "Ensuring all food preparation surfaces are hygienically clean and safe for your family." }
      ]
    },
    {
      title: "Appliances",
      icon: Zap,
      items: [
        { name: "Refrigerators & Freezers", desc: "Deep cleaning and sanitization including shelves, drawers, and vacuuming of compressor coils/seals." },
        { name: "Ovens and Stovetops", desc: "Removing grease and baked-on food from racks, burners, knobs, and interior chambers." },
        { name: "Small Appliances", desc: "Cleaning and sanitizing microwaves, dishwashers, toasters, blenders, and coffee makers." }
      ]
    },
    {
      title: "Sinks, Faucets & Floors",
      icon: Droplets,
      items: [
        { name: "Descaling", desc: "Removing lime scale and hard water stains from sinks and faucets to restore their original shine." },
        { name: "Deep Floor Cleaning", desc: "Vacuuming and mopping of tiles, hardwood, or vinyl to remove deep-seated grease and stains." },
        { name: "Grout Cleaning", desc: "Sanitizing grout lines to eliminate food particles, bacteria, and discoloration." }
      ]
    }
  ]
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          >
            ...
            <h1 className="text-6xl md:text-8xl font-black tracking-tighter mb-8 leading-[0.9]">
              HYGIENIC <br />
              <span className="text-primary italic">KITCHEN PURITY</span>
            </h1>
            <p className="text-xl text-slate-300 max-w-2xl mx-auto leading-relaxed font-medium uppercase tracking-tight">
              Immaculate Kitchen Deep Cleaning in UAE – Hygienic and Spotless
            </p>
          </motion.div>
        </div>
      </section>
              ...
              >
                <div className="space-y-6">
                  ...
                  <p className="text-slate-600 text-lg font-medium leading-relaxed">
                    A sparkling clean kitchen is the heart of a happy home. At Homework Cleaning Services LLC, we offer comprehensive kitchen deep cleaning services to ensure your kitchen is not only visually spotless but also hygienically clean. Our professional team uses advanced cleaning techniques and eco-friendly products to tackle every corner of your kitchen.
                  </p>
                  <div className="p-8 bg-slate-50 rounded-3xl border-l-4 border-primary">
                    <p className="text-slate-700 font-bold italic">
                      "If you're looking to perform Kitchen Deep Cleaning, here's a practical checklist to keep your home clean and organized efficiently."
                    </p>
                  </div>
                </div>
      ...
      <section className="py-24 bg-slate-50 relative overflow-hidden">
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-20">
            ...
            <p className="text-slate-600 font-bold max-w-2xl mx-auto">Ensuring the highest standards of food safety and hygiene in your kitchen.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
            {[
              { 
                title: "Expertise", 
                desc: "Our team is highly trained and experienced in kitchen deep cleaning, ensuring top-quality results.", 
                icon: ShieldCheck 
              },
              { 
                title: "Attention to Detail", 
                desc: "We focus on every nook and cranny, ensuring your kitchen is spotless and hygienic.", 
                icon: Sparkles 
              },
              { 
          ...
          >
            <div className="relative z-10">
              <h4 className="text-4xl md:text-5xl font-black text-white mb-8 tracking-tighter">A Clean Kitchen is a <span className="text-primary italic">Healthy Home</span></h4>
              <p className="text-slate-400 text-lg mb-10 font-bold">Contact us today for a professional kitchen deep cleaning experience.</p>
            ...
            <UtensilsCrossed className="absolute -bottom-10 -right-10 h-64 w-64 text-white/5 rotate-12 group-hover:scale-110 transition-transform duration-1000" />
          </motion.div>
        </div>
      </section>
    </div>
