  ...
  const categories = [
    {
      ...
      icon: Home,
      items: [
        { name: "Dusting", desc: "Meticulous dusting of all surfaces, including furniture, shelves, and décor to restore original vibrance." },
        { name: "Floors", desc: "Vacuuming and mopping of all types of flooring, including carpets, hardwood, and tiles to remove deep-seated dirt." },
        ...
        { name: "Fixtures", desc: "Thorough dusting and cleaning of light fixtures, ceiling fans, and air conditioning vents." },
        { name: "Baseboards and Molding", desc: "Detailed cleaning of baseboards, moldings, and door frames to remove dust accumulation." }
      ]
    },
    {
      title: "Bedrooms",
      icon: Bed,
      items: [
        { name: "Closets", desc: "Cleaning and organizing the inside of closets, shelves, and drawers to eliminate dust and promote order." },
        { name: "Doors and Handles", desc: "Detailed wiping down and sanitizing of all doors, handles, and frequently touched light switches." },
        { name: "Flooring", desc: "Detailed vacuuming and deep cleaning of bedroom flooring, ensuring a fresh and sterile sleeping environment." }
      ]
    },
    {
      title: "Bathrooms",
      icon: Bath,
      items: [
        { name: "Sinks, Tubs, and Showers", desc: "Thorough cleaning and sanitizing of sinks, tubs, showers, and faucets to remove soap scum, limescale, and grime." },
        { name: "Toilets", desc: "Deep cleaning and medical-grade disinfection of toilets, including under the rims and around all fixtures." },
        { name: "Mirrors and Glass", desc: "Streak-free cleaning and polishing of mirrors and glass shower doors to restore transparency." },
        { name: "Cabinets and Countertops", desc: "Meticulous cleaning and sanitizing inside and out of all cabinetry and shelving." },
        { name: "Floors", desc: "Intensive mopping and scrubbing of bathroom floors to eliminate bacteria and stubborn stains." }
      ]
    },
    {
      title: "Kitchen",
      icon: CookingPot,
      items: [
        { name: "Cabinets and Drawers", desc: "Cleaning and organizing inside and out, removing all traces of dust, debris, and shelf residues." },
        { name: "Countertops and Backsplashes", desc: "Intensive scrubbing and sanitizing to remove stubborn stains and grease, ensuring a food-safe area." },
        { name: "Appliances", desc: "Detailed cleaning of the interior and exterior of all appliances, including ovens, microwaves, and refrigerators." },
        { name: "Sinks and Faucets", desc: "Professional descaling and polishing of sinks and faucets to restore their original showroom shine." },
        { name: "Floors", desc: "Thorough mopping and high-degree cleaning of kitchen floors to maintain a perfectly sanitary environment." }
      ]
    },
    {
      ...
      icon: PlusCircle,
      items: [
        { name: "Laundry Rooms", desc: "Thorough cleaning of washers, dryers, and all surrounding floor areas to remove dust, lint, and moisture." },
        { name: "Balconies", desc: "Sweeping, mopping, and intensive scrubbing of balcony floors and handrails to remove desert dust and debris." }
      ]
    }
  ]
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          >
            ...
            <p className="text-xl text-slate-300 max-w-2xl mx-auto leading-relaxed font-medium uppercase tracking-tight">
              Top Apartment Deep Cleaning in UAE – Sparkling Results Every Time
            </p>
          </motion.div>
        </div>
      </section>
              ...
              >
                <div className="space-y-6">
                  ...
                  <p className="text-slate-600 text-lg font-medium leading-relaxed">
                    Are you looking to give your apartment a thorough, top-to-bottom clean? Homework Cleaning Services LLC is here to provide exceptional apartment deep cleaning services. Our professional team uses advanced cleaning techniques and eco-friendly products to ensure every nook and cranny of your apartment is spotless.
                  </p>
                  <div className="p-8 bg-slate-50 rounded-3xl border-l-4 border-primary">
                    <p className="text-slate-700 font-bold italic">
                      "If you're looking to perform Apartment Deep Cleaning, here's a practical checklist to keep your home clean and organized efficiently."
                    </p>
                  </div>
                </div>
                  ...
                  {servicesList.map((service, i) => (
                    <a 
                      ...
                      className={`flex items-center justify-between p-4 rounded-2xl border transition-all ${
                        service.slug === "apartment-deep-cleaning" 
      ...
      <section className="py-24 bg-slate-50 relative overflow-hidden">
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-20">
            ...
            <p className="text-slate-600 font-bold max-w-2xl mx-auto">Ensuring the highest standards of hygiene and comfort in your urban sanctuary.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
            {[
              { 
                title: "Expertise", 
                desc: "Our team is highly trained and experienced in apartment deep cleaning, ensuring top-notch results.", 
                icon: ShieldCheck 
              },
              { 
                title: "Attention to Detail", 
                desc: "We focus on every nook and cranny, ensuring your apartment is spotless.", 
                icon: Sparkles 
              },
              { 
          ...
          >
            <div className="relative z-10">
              <h4 className="text-4xl md:text-5xl font-black text-white mb-8 tracking-tighter">Your Sanctuary, <span className="text-primary italic">Perfectly Cleaned</span></h4>
              <p className="text-slate-400 text-lg mb-10 font-bold">Contact us today for a professional apartment deep cleaning experience.</p>
            ...
            <Building className="absolute -bottom-10 -right-10 h-64 w-64 text-white/5 rotate-12 group-hover:scale-110 transition-transform duration-1000" />
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-24 bg-white relative">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto">
            <BookingFormProvider preselectedServiceName="Apartment Deep Cleaning" />
          </div>
        </div>
      </section>
    </div>
