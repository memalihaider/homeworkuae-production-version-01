...
export default function GreaseTrapCleaning() {
  return <ServicePageTemplate slug="grease-trap-cleaning" />
}
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            >
              <img
                src="https://images.unsplash.com/photo-1556911220-e150213ff337?auto=format&fit=crop&q=80&w=1000"
                alt="Grease Trap Cleaning"
            ...
            >
              <div className="inline-flex items-center gap-3 text-primary">
                ...
                <span className="text-sm font-black uppercase tracking-widest">FOG Management Specialists</span>
              </div>
              <h2 className="text-4xl md:text-5xl font-black text-slate-900 tracking-tighter leading-tight">
                Prevent Costly Clogs: <br />
                <span className="text-primary italic">Active Grease Management</span>
              </h2>
              <p className="text-slate-600 text-lg font-medium leading-relaxed">
                The accumulation of grease in your plumbing system can lead to significant problems. At Homework Cleaning Services LLC, we provide municipality-approved grease trap cleaning to protect your business from foul odors, plumbing disasters, and regulatory fines. Regular maintenance ensures your kitchen remains operational and hygienic.
              </p>

              <div className="grid gap-4">
                {[
                  "Slow Drain Identification",
                  "Foul Odour Elimination",
                  "Full Waste Vacuum Pumping",
                  "High-Pressure Internal Washing",
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
              >
                Book Grease Trap Clean <ArrowRight className="h-5 w-5" />
              </motion.a>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-24 bg-slate-950 text-white relative">
        ...
        >
          <div className="relative z-10">
            <h4 className="text-4xl md:text-5xl font-black text-white mb-8 tracking-tighter">Keep Your Grease Traps <span className="text-primary italic">Clean & Compliant</span></h4>
            <p className="text-slate-400 text-lg mb-10 font-bold">Contact us today for professional grease trap cleaning services.</p>
