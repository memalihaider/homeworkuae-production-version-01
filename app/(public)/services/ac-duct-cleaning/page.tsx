            ...
            <div className="lg:col-span-4 order-1 lg:order-2 space-y-8">
              ...
              >
                ...
                <div className="mt-12 p-8 bg-primary/10 rounded-3xl border border-primary/20 text-center">
                  <p className="text-sm font-bold text-primary mb-4 uppercase tracking-[0.2em]">Contact Us</p>
                  <p className="text-2xl font-black text-white tracking-tighter mb-8 italic leading-tight">Breathe Clean,<br />Save Energy</p>
      ...
      <section className="py-24 bg-slate-900 overflow-hidden relative">
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center mb-16">
            <h2 className="text-sm font-black text-primary uppercase tracking-[0.4em] mb-4">Service Excellence</h2>
            <h3 className="text-4xl md:text-5xl font-black text-white tracking-tighter uppercase mb-6">SEE OUR DUCT CLEANING PROCESS</h3>
          </div>
      ...
      <section className="py-24 bg-slate-50 relative overflow-hidden">
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-20">
            <h2 className="text-sm font-black text-primary uppercase tracking-[0.4em] mb-4">The Homework Edge</h2>
            <h3 className="text-5xl font-black text-slate-900 tracking-tighter uppercase mb-6">WHY CHOOSE OUR IAQ SPECIALISTS?</h3>
            <p className="text-slate-600 font-bold max-w-2xl mx-auto italic">“Investing in regular duct cleaning saves you money in the long run and enhances your indoor air quality.”</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
            {[
              { 
                ...
                desc: "Are we certified? Yes. Our technicians are trained in the latest IAQ standards to ensure your home meets health safety guidelines.", 
                icon: ShieldCheck 
              },
              { 
                title: "Advanced Equipment", 
                desc: "We use air scrubbing and negative air pressure capture systems to ensure no dust escapes into your living space during the clean.", 
                icon: Sparkles 
              },
              { 
                title: "Transparent Pricing", 
                desc: "Standard cleaning ranges from 700 to 1000 AED—far more cost-effective than the thousands required for major duct repairs.", 
                icon: Zap 
              },
              { 
                title: "Proven Results", 
                desc: "Research is key. We have years of business experience in the UAE, providing residents with measurable airflow improvements.", 
                icon: Activity 
              }
            ].map((value, i) => (
              <motion.div
          ...
          >
            <div className="relative z-10">
              <h4 className="text-4xl md:text-5xl font-black text-white mb-8 tracking-tighter uppercase whitespace-pre-line">
                ...
                <span className="text-primary italic">CLEAN SAVINGS</span>
              </h4>
              <p className="text-slate-400 text-lg mb-10 font-bold max-w-2xl mx-auto">
                Don’t wait for a respiratory problem or a high energy bill to arise—schedule your professional duct cleaning today.
              </p>
            ...
            <Wind className="absolute -bottom-10 -left-10 h-64 w-64 text-white/5 -rotate-12 group-hover:scale-110 transition-transform duration-1000" />
