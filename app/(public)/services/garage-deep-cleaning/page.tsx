        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          >
            ...
            <p className="text-xl text-slate-300 max-w-2xl mx-auto leading-relaxed font-medium">
              Organized and Clean Spaces in UAE – Restore Your Garage Mastery
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            >
              <img
                src="https://images.unsplash.com/photo-1590674899484-d5640e25ed30?auto=format&fit=crop&q=80&w=1000"
                alt="Garage Deep Cleaning"
            ...
            >
              <div className="inline-flex items-center gap-3 text-primary">
                ...
                <span className="text-sm font-black uppercase tracking-widest">Garage Specialists</span>
              </div>
              <h2 className="text-4xl md:text-5xl font-black text-slate-900 tracking-tighter leading-tight">
                Transform Your <br />
                <span className="text-primary italic">Garage Space</span>
              </h2>
              <p className="text-slate-600 text-lg font-medium leading-relaxed">
                A clean and organized garage can make a world of difference in your home. At Homework Cleaning Services LLC, we specialize in providing thorough garage deep cleaning services to transform your garage into a spotless, functional space using advanced cleaning techniques and eco-friendly products.
              </p>

              <div className="grid gap-4">
                {[
                  "Walls, Ceilings & Cobwebs",
                  "Oil & Grease Stain Removal",
                  "Floor Mopping & Pressure Washing",
                  "Shelves & Cabinet Cleaning",
                  "Tool & Equipment Organization",
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
              >
                Book Garage Deep Clean <ArrowRight className="h-5 w-5" />
              </motion.a>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-24 bg-slate-950 text-white relative">
        ...
        >
          <div className="relative z-10">
            <h4 className="text-4xl md:text-5xl font-black text-white mb-8 tracking-tighter">Transform Your <span className="text-primary italic">Garage</span></h4>
            <p className="text-slate-400 text-lg mb-10 font-bold">Contact us today for professional garage deep cleaning services.</p>
