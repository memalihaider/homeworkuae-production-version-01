          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            >
              <div className="inline-flex items-center gap-3 text-primary">
                ...
                <span className="text-sm font-black uppercase tracking-widest">Apartment Specialists</span>
              </div>
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
              >
                Book Apartment Deep Clean <ArrowRight className="h-5 w-5" />
              </motion.a>
            </motion.div>
          </div>
        </div>
