...
export default function WindowCleaning() {
  return <ServicePageTemplate slug="window-cleaning" />
}
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            >
              <div className="inline-flex items-center gap-3 text-primary">
                ...
                <span className="text-sm font-black uppercase tracking-widest">Window Cleaning Specialists</span>
              </div>
              <h2 className="text-4xl md:text-5xl font-black text-slate-900 tracking-tighter leading-tight">
                Streak-Free <br />
                <span className="text-primary italic">Window Cleaning</span>
              </h2>
              ...
              <div className="grid gap-4">
                {[
                  ...
                  "Fly Screen Cleaning & Inspection",
                  "Commercial Office Building Windows",
                  "High-Rise Window Access Solutions",
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
              >
                Book Window Cleaning <ArrowRight className="h-5 w-5" />
              </motion.a>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-24 bg-slate-950 text-white relative">
        ...
        >
          <div className="relative z-10">
            <h4 className="text-4xl md:text-5xl font-black text-white mb-8 tracking-tighter">Enjoy <span className="text-primary italic">Crystal Clear Windows</span></h4>
            <p className="text-slate-400 text-lg mb-10 font-bold">Contact us today for professional window cleaning services.</p>
