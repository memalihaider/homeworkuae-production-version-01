      ...
      <section className="py-24 bg-slate-950 text-white relative">
        ...
        >
          <div className="relative z-10">
            <h4 className="text-4xl md:text-5xl font-black text-white mb-8 tracking-tighter">Restore Your Sofa's <span className="text-primary italic">Freshness</span></h4>
            <p className="text-slate-400 text-lg mb-10 font-bold">Contact us today for professional sofa deep cleaning services.</p>
