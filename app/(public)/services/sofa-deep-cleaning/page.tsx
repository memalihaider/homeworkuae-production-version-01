...
export default function SofaDeepCleaning() {
  return <ServicePageTemplate slug="sofa-deep-cleaning" />
}
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            >
              <div className="inline-flex items-center gap-3 text-primary">
                ...
                <span className="text-sm font-black uppercase tracking-widest">Upholstery Specialists</span>
              </div>
              <h2 className="text-4xl md:text-5xl font-black text-slate-900 tracking-tighter leading-tight">
                Like-New <br />
                <span className="text-primary italic">Sofa Deep Cleaning</span>
              </h2>
              ...
              <div className="grid gap-4">
                {[
                  ...
                  "Targeted Spot Pre-Treatment",
                  "High-Power Vacuum Extraction",
                  "Hot Steam Deep Sanitization",
                  "Stubborn Stain Removal",
                  "Premium Fabric Protection Coating",
                ].map((item, i) => (
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
              >
                Book Sofa Deep Clean <ArrowRight className="h-5 w-5" />
              </motion.a>
            </motion.div>
          </div>
        </div>
