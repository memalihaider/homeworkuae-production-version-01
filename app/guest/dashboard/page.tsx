...
const announcements = [
  ...
  { 
    ...
    excerpt: 'Homeware is committed to sustainability. Learn about our new eco-friendly practices and green service options.',
    date: '2024-01-25',
    category: 'News',
    image: null
  },
...
const companyInfo = {
  about: 'Homeware is a leading provider of home and commercial maintenance services in the UAE. With over 15 years of experience, we deliver exceptional quality and customer satisfaction.',
  founded: '2009',
  employees: '500+',
        ...
        <header className="sticky top-0 z-30 bg-slate-900/80 backdrop-blur-xl border-b border-slate-700/50">
          <div className="flex items-center justify-between px-4 lg:px-6 py-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-xl font-bold text-white">Welcome to Homeware</h1>
