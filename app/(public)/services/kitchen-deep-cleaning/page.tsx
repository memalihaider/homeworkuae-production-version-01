          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            >
              <div className="inline-flex items-center gap-3 text-primary">
                ...
                <span className="text-sm font-black uppercase tracking-widest">Kitchen Specialists</span>
              </div>
              <h2 className="text-4xl md:text-5xl font-black text-slate-900 tracking-tighter leading-tight">
                Deep Kitchen <br />
                <span className="text-primary italic">Sanitization & Degreasing</span>
              </h2>
              ...
              <div className="grid gap-4">
                {[
                  ...
                  "Stubborn Stain & Grease Removal",
                  "Full Refrigerator & Freezer Clean",
                  "Oven & Stovetop Deep Degreasing",
                  "Descaling of Taps & Sinks",
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
              >
                Book Kitchen Deep Clean <ArrowRight className="h-5 w-5" />
              </motion.a>
            </motion.div>
          </div>
        </div>
