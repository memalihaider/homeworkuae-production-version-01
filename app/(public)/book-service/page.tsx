...
export default function BookService() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (step < totalSteps) {
      ...
      alert("Your booking request has been sent! Our representative will call you within 15 minutes.")
    }
  }
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          >
            ...
            <h1 className="text-6xl md:text-7xl font-black tracking-tighter mb-8 leading-[0.9]">
              SECURE YOUR <br />
              <span className="text-primary italic lowercase">premium session</span>
            </h1>
            <p className="text-xl text-slate-300 font-bold uppercase tracking-tight italic">
              UAE's most reliable hygiene booking system. Simple, fast, professional.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="max-w-5xl mx-auto">
              ...
              <div className="bg-slate-900 md:w-80 p-12 text-white flex flex-col justify-between border-r border-white/5">
                <div className="space-y-12">
                  <div className="space-y-6">
                    <h3 className="text-[10px] font-black text-primary uppercase tracking-[0.4em]">Booking Steps</h3>
                    <div className="space-y-8">
                       {[
                        ...
                        <div key={idx} className={`flex items-center gap-4 transition-all duration-500 ${step >= item.s ? "opacity-100" : "opacity-30"}`}>
                          <div className={`h-10 w-10 rounded-xl flex items-center justify-center font-black text-xs ${step > item.s ? "bg-primary text-white" : step === item.s ? "bg-white text-slate-900 shadow-xl shadow-white/10" : "bg-white/5 text-white"}`}>
                  ...
                  <div className="pt-12 border-t border-white/5 space-y-6">
                    <h4 className="text-[10px] font-black text-slate-500 uppercase tracking-[0.4em]">Why Us?</h4>
                    <div className="space-y-4">
                      <div className="flex gap-3">
                        <ShieldCheck className="h-4 w-4 text-primary shrink-0" />
                        <p className="text-xs font-bold text-slate-300 italic">Vetted Professionals</p>
                      </div>
                      <div className="flex gap-3">
                        <Zap className="h-4 w-4 text-primary shrink-0" />
                        <p className="text-xs font-bold text-slate-300 italic">15-Min Response</p>
                      </div>
                      <div className="flex gap-3">
                        <Sparkles className="h-4 w-4 text-primary shrink-0" />
                        <p className="text-xs font-bold text-slate-300 italic">Satisfaction Guaranteed</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-12 pt-12 border-t border-white/5">
                  <p className="text-[10px] text-slate-500 font-bold uppercase tracking-widest leading-relaxed">
                    ...
                    <a href="tel:80046639675" className="text-white hover:text-primary transition-colors">800-HOMEWORK</a>
                  </p>
                </div>
              </div>
                ...
                <form onSubmit={handleSubmit} className="flex flex-col h-full">
                  <AnimatePresence mode="wait">
                    {step === 1 && (
                      ...
                      >
                        <div className="space-y-2">
                          <h2 className="text-4xl font-black text-slate-900 uppercase tracking-tighter">Your Details</h2>
                          <p className="text-slate-400 font-bold italic">Tell us who you are so we can reach you better.</p>
                        </div>

                        <div className="grid gap-6">
                          <div className="space-y-2">
                            <label className="text-[10px] font-black text-slate-900 uppercase tracking-widest pl-1">Full Identity</label>
                          ...
                          <div className="space-y-2">
                            <label className="text-[10px] font-black text-slate-900 uppercase tracking-widest pl-1">Contact Phone</label>
                            <div className="relative group">
                          ...
                          <div className="space-y-2">
                            <label className="text-[10px] font-black text-slate-900 uppercase tracking-widest pl-1">Email Address</label>
                            <div className="relative group">
                    ...
                    {step === 2 && (
                      ...
                      >
                        <div className="space-y-2">
                          <h2 className="text-4xl font-black text-slate-900 uppercase tracking-tighter">Services</h2>
                          <p className="text-slate-400 font-bold italic">Select the type of hygiene restoration required.</p>
                        </div>

                        <div className="grid gap-6">
                          <div className="space-y-2">
                            <label className="text-[10px] font-black text-slate-900 uppercase tracking-widest pl-1">Required Service</label>
                            <select 
                              name="service"
                          ...
                          <div className="grid grid-cols-2 gap-6">
                            <div className="space-y-2">
                              <label className="text-[10px] font-black text-slate-900 uppercase tracking-widest pl-1">Property</label>
                              <select 
                                name="propertyType"
                            ...
                            <div className="space-y-2">
                              <label className="text-[10px] font-black text-slate-900 uppercase tracking-widest pl-1">Frequency</label>
                              <select 
                                name="frequency"
                          ...
                          <div className="space-y-2">
                            <label className="text-[10px] font-black text-slate-900 uppercase tracking-widest pl-1">General Area / Location</label>
                            <div className="relative group">
                    ...
                    {step === 3 && (
                      ...
                      >
                        <div className="space-y-2">
                          <h2 className="text-4xl font-black text-slate-900 uppercase tracking-tighter">Availability</h2>
                          <p className="text-slate-400 font-bold italic">When should we arrive for the restoration?</p>
                        </div>

                        <div className="grid gap-6">
                          <div className="grid grid-cols-2 gap-6">
                            <div className="space-y-2">
                              <label className="text-[10px] font-black text-slate-900 uppercase tracking-widest pl-1">Target Date</label>
                              <div className="relative group">
                            ...
                            <div className="space-y-2">
                              <label className="text-[10px] font-black text-slate-900 uppercase tracking-widest pl-1">Preferred Time</label>
                              <div className="relative group">
                          ...
                          <div className="space-y-2">
                            <label className="text-[10px] font-black text-slate-900 uppercase tracking-widest pl-1">Special Notes</label>
                            <textarea 
                              name="message"
                  ...
                  <div className="pt-12 flex items-center justify-between gap-6">
                    ...
                    <button
                      type="submit"
                      className="h-16 px-12 bg-primary text-white rounded-2xl font-black uppercase text-[10px] tracking-widest shadow-2xl shadow-primary/30 hover:bg-pink-600 transition-all flex items-center gap-4 active:scale-95 flex-1 md:flex-initial justify-center"
                    >
            ...
            <div className="mt-24 grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
              <div className="space-y-4">
                ...
                <h4 className="text-xl font-black text-slate-900 uppercase tracking-tight">Fully Insured</h4>
                <p className="text-sm text-slate-500 font-bold italic">Your property is protected with our comprehensive public liability insurance.</p>
              </div>
              <div className="space-y-4">
                <div className="h-16 w-16 bg-white rounded-2xl shadow-lg flex items-center justify-center mx-auto text-primary">
                  <Star className="h-8 w-8" />
                </div>
                <h4 className="text-xl font-black text-slate-900 uppercase tracking-tight">DM Approved</h4>
                <p className="text-sm text-slate-500 font-bold italic">Our technical services use only municipality-approved chemicals and processes.</p>
              </div>
              <div className="space-y-4">
                <div className="h-16 w-16 bg-white rounded-2xl shadow-lg flex items-center justify-center mx-auto text-primary">
                  <Phone className="h-8 w-8" />
                </div>
                <h4 className="text-xl font-black text-slate-900 uppercase tracking-tight">24/7 Support</h4>
                <p className="text-sm text-slate-500 font-bold italic">Our customer happiness team is always available for your inquiries.</p>
              </div>
            </div>
          </div>
        </div>
