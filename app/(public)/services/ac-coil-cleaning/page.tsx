          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            >
              <div className="inline-flex items-center gap-3 text-primary">
                ...
                <span className="text-sm font-black uppercase tracking-widest">AC Coil Specialists</span>
              </div>
              <h2 className="text-4xl md:text-5xl font-black text-slate-900 tracking-tighter leading-tight">
                Keep Your Cool: A Comprehensive <br />
                <span className="text-primary italic">Guide to AC Coil Cleaning</span>
              </h2>
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
              >
                Book AC Coil Clean <ArrowRight className="h-5 w-5" />
              </motion.a>
            </motion.div>
          </div>
        </div>
