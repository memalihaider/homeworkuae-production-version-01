...
import { 
  ...
  Share, Edit2, Users, Search, Camera, LayoutDashboard
} from 'lucide-react'
...
export default function SurveyFormSection() {
  ...
  // ✅ FIXED: Wrapped in a proper container with padding
  return (
    <div className="p-6 space-y-6 max-w-7xl mx-auto">
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="text-xs text-gray-400">
          {selectedSurvey ? `Editing: ${selectedSurvey.title}` : 'Creating New Survey'}
        </div>
      </div>
