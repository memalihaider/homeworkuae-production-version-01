...
export default function MattressDeepCleaning() {
  return <ServicePageTemplate slug="mattress-deep-cleaning" />
}
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            >
              <img
                src="https://images.unsplash.com/photo-1632342527264-42620f2c62c9?auto=format&fit=crop&q=80&w=1000"
                alt="Mattress Deep Cleaning"
            ...
            >
              <div className="inline-flex items-center gap-3 text-primary">
                ...
                <span className="text-sm font-black uppercase tracking-widest">Mattress Specialists</span>
              </div>
              <h2 className="text-4xl md:text-5xl font-black text-slate-900 tracking-tighter leading-tight">
                Healthier Sleep, <br />
                <span className="text-primary italic">Cleaner Mattress</span>
              </h2>
              ...
              <div className="grid gap-4">
                {[
                  "Full Mattress Assessment",
                  "Targeted Spot Pre-Treatment",
                  "High-Power Vacuum Extraction",
                  "Hot Steam Deep Sanitization",
                  "Tough Stain Removal Treatment",
                  "Odour Neutralisation & Freshening",
                ].map((item, i) => (
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
              >
                Book Mattress Deep Clean <ArrowRight className="h-5 w-5" />
              </motion.a>
            </motion.div>
          </div>
        </div>
